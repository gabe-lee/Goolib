...
pub const GPU_VertexElementFormat = enum(c_uint) {
    ...
    I32_x1 = C.SDL_GPU_VERTEXELEMENTFORMAT_INT,
    I32_x2 = C.SDL_GPU_VERTEXELEMENTFORMAT_INT2,
    I32_x3 = C.SDL_GPU_VERTEXELEMENTFORMAT_INT3,
    I32_x4 = C.SDL_GPU_VERTEXELEMENTFORMAT_INT4,
    U32_x1 = C.SDL_GPU_VERTEXELEMENTFORMAT_UINT,
    U32_x2 = C.SDL_GPU_VERTEXELEMENTFORMAT_UINT2,
    U32_x3 = C.SDL_GPU_VERTEXELEMENTFORMAT_UINT3,
    U32_x4 = C.SDL_GPU_VERTEXELEMENTFORMAT_UINT4,
    F32_x1 = C.SDL_GPU_VERTEXELEMENTFORMAT_FLOAT,
    F32_x2 = C.SDL_GPU_VERTEXELEMENTFORMAT_FLOAT2,
    F32_x3 = C.SDL_GPU_VERTEXELEMENTFORMAT_FLOAT3,
    F32_x4 = C.SDL_GPU_VERTEXELEMENTFORMAT_FLOAT4,
    I8_x2 = C.SDL_GPU_VERTEXELEMENTFORMAT_BYTE2,
    I8_x4 = C.SDL_GPU_VERTEXELEMENTFORMAT_BYTE4,
    U8_x2 = C.SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2,
    U8_x4 = C.SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4,
    I8_x2_normalized = C.SDL_GPU_VERTEXELEMENTFORMAT_BYTE2_NORM,
    I8_x4_normalized = C.SDL_GPU_VERTEXELEMENTFORMAT_BYTE4_NORM,
    U8_x2_normalized = C.SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2_NORM,
    U8_x4_normalized = C.SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4_NORM,
    I16_x2 = C.SDL_GPU_VERTEXELEMENTFORMAT_SHORT2,
    I16_x4 = C.SDL_GPU_VERTEXELEMENTFORMAT_SHORT4,
    U16_x2 = C.SDL_GPU_VERTEXELEMENTFORMAT_USHORT2,
    U16_x4 = C.SDL_GPU_VERTEXELEMENTFORMAT_USHORT4,
    I16_x2_normalized = C.SDL_GPU_VERTEXELEMENTFORMAT_SHORT2_NORM,
    I16_x4_normalized = C.SDL_GPU_VERTEXELEMENTFORMAT_SHORT4_NORM,
    U16_x2_normalized = C.SDL_GPU_VERTEXELEMENTFORMAT_USHORT2_NORM,
    U16_x4_normalized = C.SDL_GPU_VERTEXELEMENTFORMAT_USHORT4_NORM,
    F16_x2 = C.SDL_GPU_VERTEXELEMENTFORMAT_HALF2,
    F16_x4 = C.SDL_GPU_VERTEXELEMENTFORMAT_HALF4,
