...
// const AllocInfallable = Root.AllocatorInfallible;
...
//             ensure_additional_capacity: *const fn (implementor: *anyopaque, count: usize, alloc: AllocInfallable) void,
...
//             shrink_capacity_but_keep_n_additional: *const fn (implementor: *anyopaque, keep_extra_capacity: usize, alloc: AllocInfallable) void,
...
//             get_item: *const fn (implementor: *anyopaque, idx: usize) GetPtrResult,
...
//             get_many_items: *const fn (implementor: *anyopaque, start_idx: usize, count: usize) GetItemsAsSliceResult,
//         };
